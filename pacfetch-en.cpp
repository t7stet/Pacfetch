...
int main() {
    ...
    std::cout << "   .--.                │ \033[0;33m Version\033[0;39m: " << version;
    std::cout << "  / _.-' .-.  .-.  .-. │ \033[0;32m Packages\033[0;39m: " << totalPackages;
    std::cout << "  \\  '-. '-'  '-'  '-' │ \033[0;34m Explicit packages\033[0;39m: " << explicitPackages;
    std::cout << "   '--'                │ \033[0;31m Avalible updates\033[0;39m: " << availableUpdates << "\n";
    return 0;
}
